...
TreePred <- AllDTPred[,1]
PredTable_Ave <- table(TreePred,TestRainTomorrow)
for (i in 2:length(AllDTree)){
    TreePred <- AllDTPred[,i]
    PredTable_Ave <- PredTable_Ave + table(TreePred,TestRainTomorrow)
}
PredTable_Ave <- PredTable_Ave/length(AllDTree)
PredTable_Ave
