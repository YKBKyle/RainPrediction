...
YesData_TrainRow <- sample(1:nrow(YesData),ceiling(nrow(YesData)*TrainRatio))
YesData_ValTestRow <- setdiff(1:nrow(YesData),YesData_TrainRow)
YesData_ValRow <- sample(YesData_ValTestRow,ceiling(nrow(YesData)*ValRatio))
YesData_TestRow <- setdiff(YesData_ValTestRow,YesData_ValRow)

NoData_TestRow <- sample(1:nrow(NoData),length(YesData_TestRow))
NoData_ValTrainRow <- setdiff(1:nrow(NoData),NoData_TestRow)
NoData_ValRow <- sample(NoData_ValTrainRow,length(YesData_ValRow))
NoData_TrainRow <- setdiff(NoData_ValTrainRow,NoData_ValRow)

ValData <- rbind(YesData[YesData_ValRow,],NoData[NoData_ValRow,])
TestData <- rbind(YesData[YesData_TestRow,],NoData[NoData_TestRow,])
Shuffle <- function(DataFrame){}
sample(1:nrow(ValData))
